#include <stdio.h>      // per poter usare printf e altre funzioni relative al input/output
#include <stdlib.h>     // contiene la definizione della funzione exit
#include <unistd.h> 	/* per poter usare, oltre che la primitiva close, anche read e write */
#include <fcntl.h>      // contiene la definizione della funzione open e le relative costanti 
